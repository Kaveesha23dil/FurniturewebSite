            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <span className="text-2xl font-bold tracking-tight text-gray-900">Urban Nest</span>
                    </div>

                    {/* Desktop Menu */}
                    <div className="hidden md:flex space-x-8 items-center">
                        {['Product', 'About Us', 'Our Store', 'Delivery'].map((item) => (
                            <a
                                key={item}
                                href="#"
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <button className="text-gray-600 hover:text-gray-900 transition-transform hover:scale-110 relative">
